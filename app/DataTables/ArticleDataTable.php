        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($row) {
                ...
                if ($row->deleted_at != null) {
                    $btnRestore = '<button onClick="restoreConfirm(' . "'" . route('articles.restore', $row->id) . "'" . ', ' . "'#article-table'" . ')" class="btn btn-success btn-sm text-white"> <i class="fas fa-trash-arrow-up"></i> </button> ';
                } else {
                    $btnEdit = '<a href="' . route('articles.edit', $row->id) . '"> <button class="btn btn-warning btn-sm text-white"> <i class="fas fa-edit"></i> </button> </a> ';
                    $btnDelete = '<button onClick="deleteConfirm(' . "'" . route('articles.destroy', $row->id) . "'" . ', ' . "'#article-table'" . ')" class="btn btn-danger btn-sm text-white"> <i class="fas fa-trash"></i> </button> ';
                }
