        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($row) {
                ...
                if ($row->deleted_at != null) {
                    $btnRestore = '<button onClick="restoreConfirm(' . "'" . route('news.restore', $row->id) . "'" . ', ' . "'#news-table'" . ')" class="btn btn-success btn-sm text-white"> <i class="fas fa-trash-arrow-up"></i> </button> ';
                } else {
                    $btnEdit = '<a href="' . route('news.edit', $row->id) . '"> <button class="btn btn-warning btn-sm text-white"> <i class="fas fa-edit"></i> </button> </a> ';
                    $btnDelete = '<button onClick="deleteConfirm(' . "'" . route('news.destroy', $row->id) . "'" . ', ' . "'#news-table'" . ')" class="btn btn-danger btn-sm text-white"> <i class="fas fa-trash"></i> </button> ';
                }
